...
const countryModel = require('../models/sql/countries');
const cityModel = require('../models/sql/city');
const cinemaModel = require('../models/sql/cinemas');
const movieModel = require('../models/sql/movies');
const genreModel = require('../models/sql/genres');
const classificationModel = require('../models/sql/classifications');
const roomModel = require('../models/sql/rooms');
const seatModel = require('../models/sql/seats');
const funcModel = require('../models/sql/functions');
const reservationModel = require('../models/sql/reservations');
const reservedSeatModel = require('../models/sql/reservedSeats');
const productCategoryModel = require('../models/sql/productCategories');
const productModel = require('../models/sql/products');
const transactionModel = require('../models/sql/transactions');
const eventModel = require('../models/sql/event');
const ticketModel = require('../models/sql/tickets');
const artistModel = require('../models/sql/artists');
const concertVenueModel = require('../models/sql/concertVenues');
const concertModel = require('../models/sql/concerts');
const concertSectionModel = require('../models/sql/concertSections');
const concertSeatModel = require('../models/sql/concertSeats');
const concertReservationModel = require('../models/sql/concertReservations');
const transportCompanyModel = require('../models/sql/transportCompanies');
const transportRouteModel = require('../models/sql/transportRoutes');
const transportVehicleModel = require('../models/sql/transportVehicles');
const transportScheduleModel = require('../models/sql/transportSchedules');
const transportSeatModel = require('../models/sql/transportSeats');
